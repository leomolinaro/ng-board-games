...
export class BritComponentsService {
  ...
  readonly LAND_AREA_IDS: BritLandAreaId[] = [
    'avalon',
    'downlands',
    'wessex',
    'sussex',
  ...
  readonly SEA_AREA_IDS: BritSeaAreaId[] = [
    'icelandic-sea',
    'north-sea',
    'frisian-sea',
    'english-channel',
  ...
  readonly AREA_IDS: BritAreaId[] = [
    ...this.LAND_AREA_IDS,
    ...this.SEA_AREA_IDS,
  ];

  readonly NATION_IDS: BritNationId[] = [
    'romans',
    'romano-british',
    'normans',
    'saxons',
  ...
  readonly ROUND_IDS: BritRoundId[] = [
  ...
  getLandArea(landAreaId: BritLandAreaId): BritLandArea {
    return this.AREA[landAreaId] as BritLandArea;
  }
  getSeaArea(seaAreaId: BritSeaAreaId): BritSeaArea {
  ...
  getNationIdsOfColor(color: BritColor): BritNationId[] {
    switch (color) {
      case 'yellow':
        return ['romans', 'romano-british', 'norwegians', 'scots', 'dubliners'];
      case 'red':
        return ['saxons', 'brigantes', 'irish', 'norsemen'];
      case 'blue':
  ...
  getLeader(leaderId: BritLeaderId): BritLeader {
    return this.LEADER[leaderId];
  }
  ...
  init() {
    ...
    this.initLandArea('downlands', 'Downlands', 'england', true, [
      'avalon',
      'wessex',
      'sussex',
      'essex',
    ...
    this.initLandArea('wessex', 'Wessex', 'england', false, [
      'devon',
      'english-channel',
      'sussex',
      'downlands',
    ...
    this.initLandArea('sussex', 'Sussex', 'england', false, [
      'wessex',
      'english-channel',
      'kent',
      'essex',
    ...
    this.initLandArea('lindsey', 'Lindsey', 'england', true, [
      'north-mercia',
      'suffolk',
      'norfolk',
      'frisian-sea',
    ...
    this.initLandArea('suffolk', 'Suffolk', 'england', false, [
      'south-mercia',
      'essex',
      'frisian-sea',
      'norfolk',
    ...
    this.initLandArea('north-mercia', 'North Mercia', 'england', false, [
      'march',
      'hwicce',
      'south-mercia',
      'suffolk',
    ...
    this.initLandArea('hwicce', 'Hwicce', 'england', false, [
      'powys',
      'gwent',
      'atlantic-ocean',
      'avalon',
    ...
    this.initLandArea('devon', 'Devon', 'england', true, [
      'cornwall',
      'english-channel',
      'wessex',
      'avalon',
    ...
    this.initLandArea('gwent', 'Gwent', 'wales', true, [
      ...
      'hwicce',
      'powys',
      { id: 'devon', strait: true },
    ]);
    this.initLandArea('dyfed', 'Dyfed', 'wales', false, [
      'atlantic-ocean',
      'gwent',
      'powys',
      { id: 'devon', strait: true },
    ]);
    this.initLandArea('powys', 'Powys', 'wales', true, [
      'atlantic-ocean',
      'dyfed',
      'gwent',
      'hwicce',
    ...
    this.initLandArea('gwynedd', 'Gwynedd', 'wales', false, [
      'atlantic-ocean',
      'powys',
      'clwyd',
    ]);
    ...
    this.initLandArea('cheshire', 'Cheshire', 'england', false, [
      'clwyd',
      'march',
      'york',
      'pennines',
    ...
    this.initLandArea('york', 'York', 'england', false, [
      'pennines',
      'cheshire',
      'march',
      'north-mercia',
    ...
    this.initLandArea('lothian', 'Lothian', 'england', false, [
      'galloway',
      'cumbria',
      'pennines',
      'bernicia',
    ...
    this.initLandArea('strathclyde', 'Strathclyde', 'scotland', false, [
      'irish-sea',
      'galloway',
      'lothian',
      'dunedin',
    ...
    this.initLandArea('dalriada', 'Dalriada', 'scotland', true, [
      'irish-sea',
      'strathclyde',
      'dunedin',
      'alban',
    ...
    this.initLandArea('caithness', 'Caithness', 'scotland', true, [
      'skye',
      'moray',
      'icelandic-sea',
    ...
    this.initSeaArea('north-sea', 'North Sea', [
      'icelandic-sea',
      'mar',
      'dunedin',
      'lothian',
    ...
    this.initSeaArea('frisian-sea', 'Frisian Sea', [
      'north-sea',
      'york',
      'lindsey',
      'norfolk',
    ...
    this.initSeaArea('english-channel', 'English Channel', [
      'atlantic-ocean',
      'north-sea',
      'kent',
      'sussex',
    ...
    this.initSeaArea('irish-sea', 'Irish Sea', [
      'icelandic-sea',
      'atlantic-ocean',
      'cheshire',
      'cumbria',
    ...
    this.initSeaArea('atlantic-ocean', 'Atlantic Ocean', [
      'irish-sea',
      'cheshire',
      'clwyd',
      'gwynedd',
    ...
    this.initNation('romano-british', 'Romano-British', 'yellow', 8, 0, 0, [
      ['arthur', 'Arthur'],
    ]);
    this.initNation('normans', 'Normans', 'blue', 8, 0, 0, [
      ['william', 'William'],
    ]);
    this.initNation('saxons', 'Saxons', 'red', 20, 0, 8, [
      ['aelle', 'Aelle'],
      ['egbert', 'Egbert'],
      ['alfred', 'Alfred'],
      ['edgar', 'Edgar'],
    ...
    this.initNation('danes', 'Danes', 'green', 18, 0, 0, [
      ['ivar-and-halfdan', 'Ivar and Halfdan'],
      ['cnut', 'Cnut'],
    ...
    this.initNation('belgae', 'Belgae', 'blue', 10, 0, 0, [
      ['boudicca', 'Boudicca'],
    ]);
    this.initNation('welsh', 'Welsh', 'green', 13, 0, 0, []);
    this.initNation('brigantes', 'Brigantes', 'red', 11, 0, 0, [
      ['urien', 'Urien'],
    ]);
    ...
    this.initRound(
      ...
      new BritEventBuilder('romans')
        ...
        .majorInvasion()
        .build(),
      new BritEventBuilder('belgae')
        .special('boudicca-revolt')
        .revolt(1)
        .leader('boudicca')
        .build()
    );
    ...
    this.initRound(
      ...
      250,
      [],
      new BritEventBuilder('irish')
        .invasion('atlantic-ocean', 1)
        .raiding()
        .build()
    );
    this.initRound(
      ...
      new BritEventBuilder('saxons')
        .invasion('english-channel', 3)
        .raiding()
        .build(),
      new BritEventBuilder('jutes')
        .invasion('english-channel', 2)
        .raiding()
        .build(),
    ...
    this.initRound(
      ...
      560,
      ['scoring'],
      new BritEventBuilder('romano-british')
        .revolt(0, 2)
        .leader('arthur')
        .build(),
      ...
      new BritEventBuilder('irish')
        ...
        .build(),
      new BritEventBuilder('scots')
        .invasion('irish-sea', 3)
        .leader('fergus-mor-mac-erc')
        .majorInvasion()
        .raiding()
        .boats()
        .build(),
    ...
    this.initRound(
      ...
      new BritEventBuilder('norsemen')
        .invasion('icelandic-sea', 5)
        .leader('ketil-flatnose')
        .majorInvasion()
        .raiding()
        .boats()
        .build(),
      new BritEventBuilder('danes')
        .special('danes-first-invasion')
        .invasion('north-sea', 4)
        .invasion('frisian-sea', 4)
        .raiding()
        .build(),
    ...
    this.initRound(
      ...
      new BritEventBuilder('norsemen')
        ...
        .boats()
        .build(),
      new BritEventBuilder('dubliners')
        .invasion('irish-sea', 2)
        .raiding()
        .build(),
      new BritEventBuilder('danes')
    ...
    this.initRound(
      ...
      new BritEventBuilder('dubliners')
        .invasion('irish-sea', 5)
        .leader('olaf-guthfrithsson')
        .majorInvasion()
        .boats()
        .build(),
    ...
    this.initRound(
      ...
      new BritEventBuilder('norwegians')
        .invasion('north-sea', 10)
    ...
    this.initRound(
      ...
      new BritEventBuilder('danes')
        ...
        .build(),
      new BritEventBuilder('norwegians')
        .special('norwegians-reinforcements')
        .boats()
        .build(),
