...
@Component ({
  ...
  styles: [`
    ...
    ::ng-deep {
      ...
      .brit-player-green {
        .bg-player-type-button { background-color: $green; }
      }
      .brit-player-yellow {
        .bg-player-type-button { background-color: $yellow; }
      }
    }
  `],
  ...
  config: BgHomeConfig<BritColor> = {
    ...
    playerIdCssClass: (color: BritColor) => {
      switch (color) {
        ...
        case "red": return "brit-player-red";
        case "yellow": return "brit-player-yellow";
      } // switch
    }, // playerRoleCssClass
  };
