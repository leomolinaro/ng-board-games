...
export class BritComponentsService {
  ...
  readonly LAND_AREA_IDS: BritLandAreaId[] = ["avalon", "downlands", "wessex", "sussex", "kent", "essex", "lindsey",
    "suffolk", "norfolk", "south-mercia", "north-mercia", "hwicce", "devon", "cornwall", "gwent", "dyfed", "powys",
  ...
  readonly NATION_IDS: BritNationId[] = ["romans", "romano-british", "normans", "saxons", "danes", "norwegians",
    "jutes", "angles", "belgae", "welsh", "brigantes", "caledonians", "picts", "irish",
    "scots", "norsemen", "dubliners"];
