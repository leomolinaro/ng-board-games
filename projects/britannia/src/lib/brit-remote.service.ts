...
export class BritRemoteService {
  ...
  insertGame$ (game: BritGameDoc) { return this.cloud.set$ (game.id, game, this.games ()); }
  updateGame$ (patch: Partial<BritGameDoc>, gameId: string) { return this.cloud.update$ (gameId, patch, this.games ()); }
  deleteGame$ (gameId: string) { return this.cloud.delete$ (gameId, this.games ()); }

  private players (gameId: string) { return this.cloud.collection<BritPlayerDoc> (`brit-games/${gameId}/players`); }
  ...
  insertPlayer$ (player: BritPlayerDoc, gameId: string): Observable<BritPlayerDoc> { return this.cloud.set$ (player.id, player, this.players (gameId)); }
  updatePlayer$ (patch: Partial<BritPlayerDoc>, playerId: string, gameId: string) { return this.cloud.update$ (playerId, patch, this.players (gameId)); }
  ...
  private stories (gameId: string) { return this.cloud.collection<BritStoryDoc> (`brit-games/${gameId}/stories`); }
  ...
  insertStory$ (storyId: string, story: BritStoryDoc, gameId: string) { return this.cloud.set$ (storyId, story, this.stories (gameId)); }
  updateStory$ (patch: Partial<BritStoryDoc>, storyId: string, gameId: string) { return this.cloud.update$ (storyId, patch, this.stories (gameId)); }
