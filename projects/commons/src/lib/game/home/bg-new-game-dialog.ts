...
import { TuiButton, TuiDialogContext, TuiInput, TuiLabel } from "@taiga-ui/core";
...
@Component({
  ...
  imports: [TuiInput, TuiLabel, TuiRadioList, FormsModule, TuiForm, TuiAutoFocus, TuiButton],
  template: `
    <div tuiForm>
      <tui-textfield>
...
export class BgNewGameDialog {
  protected readonly context = injectContext<TuiDialogContext<NewGame | null>>();
