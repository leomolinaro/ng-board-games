...
export class WotrLogStore {
  ...
  logEffect(effect: WotrAction, during?: "battle" | "hunt") {
    this.addLog(`logEffect [${effect.type}]`, { type: "effect", effect, during });
  }
  logStory(story: WotrGameStory, front: WotrFrontId, during?: "battle" | "hunt") {
    this.addLog("logStory", { type: "story", story, front, during });
  }
