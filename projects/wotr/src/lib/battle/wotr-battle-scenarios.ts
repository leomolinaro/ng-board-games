...
import { attack, noCombatCard, retreatIntoSiege, rollCombatDice } from "./wotr-battle-actions";
...
const battle01: WotrScenario = {
  id: "battle-01",
  name: "Battle 01",
  description: "When a field battle in a settlement is being won by the attacker",
  loadDefinition: () => ({
    setup: setupBuilder =>
      setupBuilder
