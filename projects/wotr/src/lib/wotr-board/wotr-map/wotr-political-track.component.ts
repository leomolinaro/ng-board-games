...
export class WotrPoliticalTrackComponent {
  ...
  private politicalMakerXY: Record<WotrNationId, Record<WotrPoliticalStep, { x: number; y: number }>> = {
    dwarves: { 3: { x: PX1, y: PY1 + PSTEP3 }, 2: { x: PX1, y: PY1 + PSTEP2 }, 1: { x: PX1, y: PY1 + PSTEP1 }, atWar: { x: PX1, y: PY1 + PSTEPWAR } },
    elves: { 3: { x: PX1, y: PY3 + PSTEP3 }, 2: { x: PX1, y: PY3 + PSTEP2 }, 1: { x: PX1, y: PY3 + PSTEP1 }, atWar: { x: PX1, y: PY3 + PSTEPWAR } },
    gondor: { 3: { x: PX2, y: PY1 + PSTEP3 }, 2: { x: PX2, y: PY1 + PSTEP2 }, 1: { x: PX1, y: PY2 + PSTEP1 }, atWar: { x: PX1, y: PY2 + PSTEPWAR } },
    southrons: { 3: { x: PX2, y: PY3 + PSTEP3 }, 2: { x: PX2, y: PY3 + PSTEP2 }, 1: { x: PX3, y: PY2 + PSTEP1 }, atWar: { x: PX3, y: PY2 + PSTEPWAR } },
    isengard: { 3: { x: PX1, y: PY2 + PSTEP3 }, 2: { x: PX1, y: PY2 + PSTEP2 }, 1: { x: PX2, y: PY1 + PSTEP1 }, atWar: { x: PX2, y: PY1 + PSTEPWAR } },
    sauron: { 3: { x: PX3, y: PY2 + PSTEP3 }, 2: { x: PX3, y: PY2 + PSTEP2 }, 1: { x: PX2, y: PY3 + PSTEP1 }, atWar: { x: PX2, y: PY3 + PSTEPWAR } },
    north: { 3: { x: PX3, y: PY1 + PSTEP3 }, 2: { x: PX3, y: PY1 + PSTEP2 }, 1: { x: PX3, y: PY1 + PSTEP1 }, atWar: { x: PX3, y: PY1 + PSTEPWAR } },
    rohan: { 3: { x: PX3, y: PY3 + PSTEP3 }, 2: { x: PX3, y: PY3 + PSTEP2 }, 1: { x: PX3, y: PY3 + PSTEP1 }, atWar: { x: PX3, y: PY3 + PSTEPWAR } },
  };
