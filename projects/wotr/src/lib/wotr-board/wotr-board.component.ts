...
import { WotrCardId, isCharacterCard, isStrategyCard } from "../wotr-elements/card/wotr-card.models";
...
import { WotrFront, WotrFrontId } from "../wotr-elements/front/wotr-front.models";
