...
import type { WotrActionDie } from './wotr-action-die-models';

export type WotrActionDieAction =
  WotrActionRoll | WotrActionDiceDiscard | WotrActionSkip | WotrActionDieChange;
...
export function changeActionDie(
  die: WotrActionDie,
  toDie: WotrActionDie,
): WotrActionDieChange {
