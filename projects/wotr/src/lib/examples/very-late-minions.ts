...
import { armyMovement, eliminateEliteUnit, eliminateLeader, eliminateRegularUnit, leftUnits, moveArmies, moveNazgul, recruitEliteUnit, recruitRegularUnit } from "../unit/wotr-unit-actions";
...
export const stories: WotrStoryDoc[] = [
  ...
  b.s ().phaseStory (rollHuntDice (1, 6)),
  b.s ().phaseStory (drawHuntTile ("3")),
  b.fp ().phaseStory (eliminateCharacter ("gandalf-the-grey"), changeGuide ("strider")),
  b.s ().eventDieCard ("Worn with Sorrow and Toil", playCardOnTable ("Worn with Sorrow and Toil")),
  b.fp ().characterDie (moveFelloswhip ()),
  b.s ().phaseStory (rollHuntDice (5, 2)),
  b.s ().phaseStory (drawHuntTile ("1")),
  b.fp ().phaseStory (corruptFellowship (1)),
  ...
  b.s ().armyDie (moveArmies (armyMovement ("dol-guldur", "north-anduin-vale", leftUnits (regular ("sauron", 1))), armyMovement ("morannon", "dagorlad"))),
  ...
  b.fp ().huntStory (chooseRandomCompanion ("strider")),
  b.fp ().huntStory (eliminateCharacter ("strider"), changeGuide ("legolas")),
  ...
  b.fp ().characterDie (moveFelloswhip ()),
  b.s ().huntStory (rollHuntDice (1)),
  b.s ().musterDie (advanceNation ("sauron")),
  b.fp ().pass (),
  b.s ().armyDie (moveArmies (armyMovement ("southern-rhovanion", "northern-rhovanion"), armyMovement ("far-harad", "near-harad"))),
  b.fp ().eventDieCard ("Celeborn's Galadhrim",
  ...
  b.s ().armyDie (moveArmies (armyMovement ("old-forest-road", "carrock", leftUnits (regular ("sauron", 7), elite ("sauron", 1), elite ("isengard", 1), nazgul (2))), armyMovement ("near-harad", "umbar", leftUnits (regular ("southrons", 1))))),
  ...
  b.fp ().characterDie (moveFelloswhip ()),
  b.s ().characterDieCard ("The Black Captain Commands",
  ...
  b.fp ().characterDie (moveFelloswhip ()),
  b.s ().huntStory (rollHuntDice (2, 6)),
  b.s ().huntStory (drawHuntTile ("2")),
  b.fp ().huntStory (eliminateCharacter ("legolas"), changeGuide ("gimli")),
  ...
  b.fp ().musterElvenRingDie ("narya", moveArmies (armyMovement ("fords-of-isen", "helms-deep"), armyMovement ("westemnet", "helms-deep"))),
  b.s ().armyDie (moveArmies (armyMovement ("orthanc", "fords-of-isen", leftUnits (character ("saruman"))), armyMovement ("south-rhun", "east-rhun"))),
  b.fp ().characterDie (moveFelloswhip ()),
  b.s ().huntStory (rollHuntDice (2, 2)),
  b.s ().huntStory (reRollHuntDice (1)),
  ...
  b.fp ().huntStory (revealFellowship ("southern-rhovanion")),
  // Turn 7 42:05
  ...
  b.s ().huntStory (drawHuntTile ("1r")),
  b.fp ().huntStory (corruptFellowship (1)),
  b.fp ().huntStory (revealFellowship ("noman-lands")),
  ...
  b.fp ().characterDie (moveFelloswhip ()),
  b.s ().huntStory (rollHuntDice (5, 1, 2)),
  b.s ().huntStory (reRollHuntDice (2)),
  ...
  b.s ().battleStory (advanceArmy ()),
  b.fp ().characterDie (moveFelloswhip ()),
  b.s ().huntStory (rollHuntDice (5, 4, 1)),
  b.s ().huntStory (reRollHuntDice (1)), // missing in the video
  ...
  b.fp ().willOfTheWestDie (moveFelloswhip ()),
  b.s ().huntStory (drawHuntTile ("er")),
  b.fp ().huntStory (corruptFellowship (3)),
  b.s ().characterDie (
  ...
  b.fp ().cardReaction ("Dreadful Spells",
  ...
  b.s ().battleStory (advanceArmy ()),
  b.fp ().pass (),
  b.s ().musterAbilityDie ("the-mouth-of-sauron", moveArmies (armyMovement ("dale", "erebor", leftUnits (regular ("sauron", 7))), armyMovement ("minas-morgul", "south-ithilien"))),
  b.fp ().musterArmyElvenRingDie ("nenya", moveFelloswhip ()),
  b.s ().huntStory (drawHuntTile ("b0")),
