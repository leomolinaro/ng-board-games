...
export const stories: WotrStoryDoc[] = [
  ...
  b.s().characterDie(moveArmies(armyMovement("gorgoroth", "morannon", leftUnits(regular("sauron", 3))))),
  b.fp().musterArmyDie(moveArmies(armyMovement("carrock", "old-forest-road"), armyMovement("edoras", "westemnet"))),
  b
    .s()
    .armyDie(
      moveArmies(
  ...
  b.s().armyDie(moveArmies(armyMovement("north-anduin-vale", "dimrill-dale"), armyMovement("dagorlad", "noman-lands"))),
  ...
  b
    .s()
    .armyDie(
      moveArmies(armyMovement("southern-rhovanion", "northern-rhovanion"), armyMovement("far-harad", "near-harad"))
    ),
  b.fp().eventDieCard("Celeborn's Galadhrim", recruitEliteUnit("lorien", "elves"), drawCards("Riders of Theoden")),
  ...
  b
    .s()
    .eventDieCard("Hill-trolls", eliminateRegularUnit("lorien", "sauron", 2), recruitEliteUnit("lorien", "sauron", 2)),
  ...
  b.fp().pass(),
  b.s().musterDie(eliminateRegularUnit("orthanc", "isengard", 2), recruitEliteUnit("orthanc", "isengard", 2)),
  b.fp().pass(),
  b.s().musterDie(eliminateRegularUnit("orthanc", "isengard", 2), recruitEliteUnit("orthanc", "isengard", 2)),
  b
    .fp()
    .musterElvenRingDie(
      "narya",
      moveArmies(armyMovement("fords-of-isen", "helms-deep"), armyMovement("westemnet", "helms-deep"))
    ),
  b
    .s()
    .armyDie(
  ...
  b.s().battleStory(advanceArmy()),
  b.fp().eventDieCard("I Will Go Alone", separateCompanions("druadan-forest", "boromir"), healFellowship(1)),
  ...
  b.s().combatCardReaction("Grond, Hammer of the Unnderworld", forfeitLeadership(character("the-witch-king"))),
  ...
  b.fp().battleStory(eliminateEliteUnit("helms-deep", "rohan"), recruitRegularUnit("helms-deep", "rohan")),
  ...
  b.s().battleStory(eliminateEliteUnit("helms-deep", "isengard"), recruitRegularUnit("helms-deep", "isengard")),
  b
    .s()
    .battleStory(
  ...
  b.s().battleStory(eliminateEliteUnit("helms-deep", "sauron"), recruitRegularUnit("helms-deep", "sauron")),
  b.fp().battleStory(eliminateRegularUnit("helms-deep", "rohan"), eliminateLeader("helms-deep", "rohan")),
  ...
  b.fp().huntEffect(separateCompanions("noman-lands", "gimli", "meriadoc", "peregrin"), changeGuide("gollum")),
  b.fp().pass(),
  ...
  b.fp().battleStory(eliminateEliteUnit("lorien", "elves", 2), recruitRegularUnit("lorien", "elves", 2)),
  b
    .s()
    .battleStory(
  ...
  b.fp().battleStory(reRollCombatDice(4)),
  b.s().battleStory(eliminateRegularUnit("lorien", "isengard", 3), eliminateRegularUnit("lorien", "sauron")),
  ...
  b.fp().battleStory(eliminateRegularUnit("lorien", "elves", 3), eliminateLeader("lorien", "elves")),
  b.fp().willOfTheWestDie(moveFelloswhip()),
  b.s().drawHuntTile("er"),
  ...
  b.s().battleStory(eliminateRegularUnit("erebor", "southrons"), eliminateEliteUnit("erebor", "sauron")),
