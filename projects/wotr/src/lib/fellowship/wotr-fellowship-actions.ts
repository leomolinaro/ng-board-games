...
export type WotrFellowshipAction =
  WotrFellowshipProgress | WotrFellowshipCorruption |
  WotrFellowshipDeclare | WotrFellowshipDeclareNot |
  WotrFellowshipHide | WotrFellowshipReveal | WotrFellowshipGuide;
