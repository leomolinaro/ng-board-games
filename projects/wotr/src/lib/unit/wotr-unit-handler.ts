...
export class WotrUnitHandler {
  ...
  downgradeEliteUnits(
    ...
    if (fromCasualties)
      this.nationStore.removeRegularsFromCasualties(fromCasualties, nationId);
  ...
  private removeRegularsFromRegion(
    quantity: number,
    nation: WotrNationId,
    region: WotrRegion,
  ): void {
  ...
  private removeElitesFromRegion(
    quantity: number,
    nation: WotrNationId,
    region: WotrRegion,
  ): void {
  ...
  private removeLeadersFromRegion(
    quantity: number,
    nation: WotrNationId,
    regionId: WotrRegionId,
  ): void {
