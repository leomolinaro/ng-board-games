...
export class WotrRemoteService {
  ...
  updateGame(patch: Partial<WotrGameDoc>, gameId: string) {
  ...
  getPlayers(gameId: string, queryFn?: BgCloudCollectionQuery<WotrPlayerDoc>) {
  ...
  getStories(gameId: string, queryFn?: BgCloudCollectionQuery<WotrStoryDoc>) {
