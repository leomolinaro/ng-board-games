...
export class WotrRemoteMockService {
  ...
  updateGame$ (patch: Partial<WotrGameDoc>, gameId: string): any { throw new Error ("Mock remote"); }
  deleteGame$ (gameId: string): any { throw new Error ("Mock remote"); }

  async getPlayers (gameId: string, queryFn?: BgCloudCollectionQuery<WotrPlayerDoc> | undefined): Promise<WotrPlayerDoc[]> {
    return [{ id: "free-peoples", name: "FP", controller: { } }, { id: "shadow", name: "S", controller: { } }] as any;
  }
  selectPlayers$ (gameId: string, queryFn?: BgCloudCollectionQuery<WotrPlayerDoc> | undefined): any { throw new Error ("Mock remote"); }
  selectPlayer$ (playerId: string, gameId: string): any { throw new Error ("Mock remote"); }
  insertPlayer$ (player: WotrPlayerDoc, gameId: string): any { throw new Error ("Mock remote"); }
  updatePlayer$ (patch: Partial<WotrPlayerDoc>, playerId: string, gameId: string): any { throw new Error ("Mock remote"); }
  ...
  insertStory$ (storyId: string, story: WotrStoryDoc, gameId: string): any { throw new Error ("Mock remote"); }
  deleteStory$ (storyId: string, gameId: string): any { throw new Error ("Mock remote"); }
  deleteStories$ (gameId: string): any { throw new Error ("Mock remote"); }
