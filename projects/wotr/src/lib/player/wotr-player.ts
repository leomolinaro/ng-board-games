...
export abstract class WotrPlayer {
  ...
  rollActionDice (): Promise<WotrGameStory> { return this.storyService.story (this.frontId, p => p.rollActionDice (this)); }
  ...
  actionResolution (): Promise<WotrGameStory> { return this.storyService.story (this.frontId, p => p.actionResolution (this)); }
