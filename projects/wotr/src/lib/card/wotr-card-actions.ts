import type { WotrCardId, WotrCardLabel} from './wotr-card-models';
import { labelToCardId } from './wotr-card-models';
...
export function discardCardFromTable(
  card: WotrCardLabel,
): WotrCardDiscardFromTable {
  return discardCardFromTableById(labelToCardId(card));
}

export function discardCardFromTableById(
  card: WotrCardId,
): WotrCardDiscardFromTable {
