...
export type KomeFreePeopleStrategyCardNumber =
  '08km' | '16km' | '19km' | '22km' | '24km' | '25km' | '26km';
export type KomeShadowCharacterCardNumber = '25km' | '26km';
export type KomeShadowStrategyCardNumber =
  '01km' | '03km' | '05km' | '06km' | '18km' | '25km' | '26km';

export type WotrFreePeoplesCardId =
  WotrFreePeoplesCharacterCardId | WotrFreePeoplesStrategyCardId;
export function isFreePeoplesCard(
  cardId: WotrCardId,
): cardId is WotrFreePeoplesCardId {
  return cardId.startsWith('fp');
}

export type WotrShadowCardId =
  WotrShadowCharacterCardId | WotrShadowStrategyCardId;
export function isShadowCard(cardId: WotrCardId): cardId is WotrShadowCardId {
  return cardId.startsWith('s');
}

export type WotrStrategyCardId =
  WotrFreePeoplesStrategyCardId | WotrShadowStrategyCardId;
export type WotrCardId = WotrCharacterCardId | WotrStrategyCardId;
export type WotrCardType = 'character' | 'muster' | 'army';

export type WotrCharacterCardId =
  WotrFreePeoplesCharacterCardId | WotrShadowCharacterCardId;
export function isCharacterCard(
  cardId: WotrCardId,
): cardId is WotrCharacterCardId {
...
export type WotrShadowCharacterCardId =
  `scha${WotrCardNumber | KomeShadowCharacterCardNumber}`;
export function isShadowCharacterCard(
  cardId: WotrCardId,
): cardId is WotrShadowCharacterCardId {
  return cardId.startsWith('scha');
}

export type WotrShadowStrategyCardId =
  `sstr${WotrCardNumber | KomeShadowStrategyCardNumber}`;
export function isShadowStrategyCard(
  cardId: WotrCardId,
): cardId is WotrShadowStrategyCardId {
  return cardId.startsWith('sstr');
}

export function isStrategyCard(
  cardId: WotrCardId,
): cardId is WotrStrategyCardId {
