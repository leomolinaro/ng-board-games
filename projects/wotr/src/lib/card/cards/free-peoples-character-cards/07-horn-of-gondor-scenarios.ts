...
const hornOfGondor01: WotrScenario = {
  ...
  loadDefinition: () => ({
    ...
    stories: (b: WotrStoriesBuilder) => [
      ...
      b
        .fp()
        .characterDieCard('Horn of Gondor', playCardOnTable('Horn of Gondor')),
...
const hornOfGondor02: WotrScenario = {
    ...
    return {
      ...
      stories: (b: WotrStoriesBuilder) => [
        ...
        b
          .fp()
          .huntStory(
            discardCardFromTable('Horn of Gondor'),
            corruptFellowship(1),
          ),
      ],
    };
...
const hornOfGondor03: WotrScenario = {
...
const hornOfGondor04: WotrScenario = {
...
const hornOfGondor05: WotrScenario = {
