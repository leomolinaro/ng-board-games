  ...
  stories: (b: WotrStoriesBuilder) => [
    ...
    },
    {
      ...
      actions: [
        {
          type: "action-roll",
          dice: ["character", "eye", "muster-army", "character", "muster", "eye"]
        }
      ]
    },
    {
    ...
    },
    {
      ...
      actions: [
        {
          dice: ["army", "event", "event", "event", "character", "muster-army", "eye"],
          type: "action-roll"
        }
      ]
    },
    ...
    },
    {
      ...
      actions: [
        {
          type: "action-roll",
          dice: ["event", "character", "event", "muster", "muster-army", "event", "eye"]
        }
      ],
      playerId: "shadow"
    },
    ...
    },
    {
      ...
      actions: [
        {
          type: "action-roll",
          dice: ["event", "eye", "army", "eye", "muster", "army", "muster-army"]
        }
      ],
      playerId: "shadow"
    },
    ...
    },
    {
      actions: [
        {
          dice: ["will-of-the-west", "will-of-the-west", "character", "character"],
          type: "action-roll"
        }
      ],
      playerId: "free-peoples",
    ...
    },
    {
      ...
      actions: [
        {
          dice: ["eye", "eye", "event", "event", "muster-army", "muster", "eye", "eye"],
          type: "action-roll"
        }
      ],
      type: "base",
    ...
    },
    {
      ...
      actions: [
        {
          type: "action-roll",
          dice: ["character", "will-of-the-west", "will-of-the-west", "character", "character"]
        }
      ],
      playerId: "free-peoples"
    },
    {
      actions: [
        {
          type: "action-roll",
          dice: ["event", "eye", "muster", "muster", "character", "muster", "muster"]
        }
      ],
      playerId: "shadow",
      type: "base",
