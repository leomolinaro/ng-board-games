...
export const scenario: WotrScenarioDefinition = {
  ...
  stories: (b: WotrStoriesBuilder) => [
    ...
    b
      .s()
      .rollActionDice('army', 'character', 'army', 'character', 'event', 'eye'),
    b.fp().pass(),
    ...
    b
      ...
      .eventDieCard(
        ...
        playCardOnTable('Worn with Sorrow and Toil'),
      ),
    b.fp().characterDie(moveFelloswhip()),
    ...
    b
      .fpT()
      .rollActionDice('muster-army', 'character', 'event', 'will-of-the-west'),
    ...
    b
      ...
      .cardReaction(
        'Worn with Sorrow and Toil',
        discardRandomCard('The Ents Awake: Entmoot'),
      ),
    b
      .s()
      .armyDie(
        moveArmy('moria', 'dimrill-dale', leftUnits(regular('sauron', 1))),
    ...
    b
      .fpT()
      .rollActionDice('will-of-the-west', 'muster-army', 'character', 'event'),
    b
      .s()
      .rollActionDice(
        'muster',
    ...
    b
      ...
      .eventDieCard(
        'Nazgul Search',
        moveNazgul('minas-morgul', 'goblins-gate'),
      ),
    ...
    b
      ...
      .eventDieCard(
        ...
        recruitEliteUnit('old-forest-road', 'isengard'),
      ),
    ...
    b
      .s()
      .eventDieCard('Hill-trolls', upgradeRegularUnit('lorien', 'sauron', 2)),
    ...
    b
      .fpT()
      .firstPhaseDiscard('Kindred of Glorfindel', 'The Ents Awake: Huorns'),
    ...
    b
      ...
      .eventDieCard(
        ...
        discardDice('free-peoples', 'will-of-the-west'),
      ),
    b.fp().pass(),
    ...
    b.fp().combatCardReaction('The Red Arrow', moveArmy('dale', 'erebor')),
    b.s().battleStory(advanceArmy()),
    b.fp().pass(),
    ...
    b
      .s()
      .characterReaction('the-witch-king', drawCards('Orcs Multiplying Again')),
    // Turn 6 30:00
    b
      .fpT()
      .firstPhaseDraw(
    ...
    b
      .s()
      .armyDie(
        moveArmy('orthanc', 'fords-of-isen', leftUnits(character('saruman'))),
        moveArmy('south-rhun', 'east-rhun'),
      ),
    b.fp().characterDie(moveFelloswhip()),
    ...
    b
      ...
      .characterReaction(
        'the-witch-king',
        drawCards('The Breaking of the Fellowship'),
      ),
    b.s().battleStory(noCombatCard()),
    ...
    b
      ...
      .battleStory(
        ...
        downgradeEliteUnit('helms-deep', 'isengard'),
      ),
    b.s().battleStory(noCombatCard()),
    b.fp().battleStory(noCombatCard()),
    ...
    b
      .s()
      .firstPhaseDraw('Cruel Weather', 'Many Kings to the Service of Mordor'),
    ...
    b
      ...
      .battleStory(
        ...
        downgradeEliteUnit('lorien', 'sauron'),
      ),
    ...
    b
      ...
      .eventDieCard(
        'Dreadful Spells',
        targetRegion('erebor'),
        rollCombatDice(5, 2, 6, 3, 3),
      ),
    b
      .fp()
      .cardReaction(
        'Dreadful Spells',
        downgradeEliteUnit('erebor', 'dwarves', 2),
      ),
    b.fp().willOfTheWestDie(hideFellowship()),
    ...
    b
      ...
      .cardReaction(
        ...
        eliminateRegularUnit('erebor', 'north'),
      ),
    b
      .s()
      .battleStory(
        continueBattle('erebor'),
        downgradeEliteUnit('erebor', 'southrons'),
      ),
    b
      .s()
      .characterReaction('the-witch-king', drawCards('The King is Revealed')),
    ...
    b
      ...
      .combatCardReaction(
        ...
        eliminateRegularUnit('erebor', 'southrons', 2),
      ),
