...
export type WotrHuntAction = WotrHuntTileDraw | WotrHuntTileAdd;
...
export interface WotrHuntReRoll { type: "hunt-re-roll"; dice: WotrCombatDie[] }
// export function reRollHuntDice (...dice: WotrCombatDie[]): WotrHuntReRoll { return { type: "hunt-re-roll", dice }; }
