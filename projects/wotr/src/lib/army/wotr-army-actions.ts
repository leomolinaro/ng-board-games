...
import { WotrArmy } from "../game/wotr-story.models";
import { WotrMinionId } from "../minion/wotr-minion.models";
import { WotrArmyUnitType, WotrGenericUnitType, WotrNationId } from "../nation/wotr-nation.models";
import { WotrRegionId } from "../region/wotr-region.models";

export type WotrArmyAction = WotrArmyMovement | WotrUnitRecruitment | WotrUnitElimination | WotrArmyAttack | WotrArmyRetreatIntoSiege | WotrArmyNotRetreatIntoSiege;
...
class WotrLeaderComposer extends WotrGenericUnitsComposer { constructor (nation: WotrNationId, quantity: number) { super ("leader", nation, quantity); } }
