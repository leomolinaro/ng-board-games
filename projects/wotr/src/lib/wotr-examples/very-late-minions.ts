...
export const stories: WotrStoryDoc[] = [
  ...
  fp ().battleStory (chooseCombatCard ("The Power of Tom Bombadil")),
  ...
  s ().battleStory (noCombatCard ()),
  fp ().battleStory (chooseCombatCard ("The Red Arrow")),
  ...
  s ().battleStory (chooseCombatCard ("Return to Valinor")),
  fp ().battleStory (chooseCombatCard ("The Last Battle")),
