  ...
  template: `
    <div class="brit-unit-selector-container">
      ...
      <div class="brit-unit-buttons">
        <button (click)="onIncrease ()" [ngClass]="{ 'is-active': enableIncrease, 'is-disabled': !enableIncrease }"><i class="fa fa-caret-up"></i></button>
        <button (click)="onDecrease ()" [ngClass]="{ 'is-active': enableDecrease, 'is-disabled': !enableDecrease }"><i class="fa fa-caret-down"></i></button>
      </div>
      <button class="brit-unit-confirm" (click)="onConfirm ()"><i class="fa fa-check"></i></button>
    </div>
  `,
...
export class BritUnitsSelectorComponent implements OnChanges {
  ...
  ngOnChanges (changes: SimpleChanges<BritUnitsSelectorComponent>) {
